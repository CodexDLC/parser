...
def get_news_ingestion_service(session: SessionDep) -> NewsIngestionService:
    """Вернуть сервис ручного парсинга и сохранения новостей."""

    return NewsIngestionService(session)
...
NewsIngestionServiceDep = Annotated[
